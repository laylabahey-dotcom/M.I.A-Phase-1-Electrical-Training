    ...
    for item in data:
        ...
        if "num_completed_races" in item:
            vehicle = Racer(
                ...
                item["num_completed_races"], #public
...
def check_in_car():
    ...
    #bonus
    car_type = input("Enter car type (racer/supporting/ambulance): ")
...
def retire_car():
    found = 0
    car_num = int(input("Enter the number of the car you want to retire: "))
...
def garage_report():
    ...
    for vehicle in garage:
        ...
        sum_performance = sum_performance + vehicle.get_preformance_score()
    ...
    print(f"Average performance: {average_performance}7")
